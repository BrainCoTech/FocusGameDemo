...
//            }
//        });
//        findViewById(R.id.fruit).setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                startActivity(new Intent(MainActivity.this, H5CallNativeActivity.class));
//            }
//        });

        findViewById(R.id.h5Test).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this, DemoGameActivity.class));
            }
        });
